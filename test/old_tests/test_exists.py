...
class TestExists(TestBaseClass):
    ...
    def setup_class(cls):
        ...
        if user is None and password is None:
            ...
            TestExists.client = aerospike.client(
    ...
    def setup_method(self, method):
        ...
        rec = {
            ...
            'names_and_age': [{'name': 'John', 'age': 24},
                              {'name': 'Marlen', 'age': 25}]
        }
    ...
    def test_exists_with_policy_is_string(self):
        ...
        try:
            key, _ = TestExists.client.exists(key, policy)
    ...
    def test_exists_with_none_namespace(self):
        ...
        try:
            key, _ = TestExists.client.exists(key)
    ...
    def test_exists_key_type_list(self):
        """
            Invoke exists() with key specified as a list of ns,
            set and key/digest.
        """
        key = ['test', 'demo', '1']
    ...
    def test_exists_with_non_existent_key(self):
        ...
        try:
            ...
            """
            We are making the api backward compatible. In case of
            RecordNotFound an exception will not be raised. Instead
            Ok response is returned withe the
            meta as None. This might change with further releases.
            """
        except e.RecordNotFound as exception:
            assert True is False
