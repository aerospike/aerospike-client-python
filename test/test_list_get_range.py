...
class TestListGetRange(object):
    def setup_class(cls):
        ...
        if user == None and password == None:
            ...
            TestListGetRange.client = aerospike.client(config).connect(user, password)
    ...
    def test_list_get_range_with_correct_paramters(self):
        """
        Invoke list_get_range() get back elements from the list with correct parameters
        """
        key = ('test', 'demo', 1)
    ...
    def test_list_get_range_with_correct_policy(self):
        """
        Invoke list_get_range() get back elements from the list with correct policy
        """
        key = ('test', 'demo', 1)
        policy = {
            'timeout': 1000,
        ...
        bins = TestListGetRange.client.list_get_range(key, 'city', 0, 1, {}, policy)
    ...
    def test_list_get_range_with_incorrect_policy(self):
        ...
        try:
            TestListGetRange.client.list_get_range(key, "contact_no", 0, 2, {}, policy)
    ...
    def test_list_get_range_with_extra_parameter(self):
        ...
        policy = {'timeout': 1000}
        with pytest.raises(TypeError) as typeError:
            TestListGetRange.client.list_get_range(key, "contact_no", 1, 1, {}, policy, "")

        assert "list_get_range() takes at most 6 arguments (7 given)" in typeError.value
    ...
    def test_list_get_range_policy_is_string(self):
        ...
        key = ('test', 'demo', 1)
        try:
            TestListGetRange.client.list_get_range(key, "contact_no", 0, 1, {}, "")
    ...
    def test_list_get_range_with_negative_index(self):
        ...
        key = ('test', 'demo', 1)
        try:
            bins = TestListGetRange.client.list_get_range(key, "contact_no", -56, 5)
    ...
    def test_list_get_range_with_negative_length(self):
        ...
        key = ('test', 'demo', 1)
        try:
            bins = TestListGetRange.client.list_get_range(key, "contact_no", 0, -59)
        except InvalidRequest as exception:
            assert exception.code == 4
    ...
    def test_list_get_range_meta_type_integer(self):
        ...
        key = ('test', 'demo', 1)
        try:
            TestListGetRange.client.list_get_range(key, "contact_no", 0, 2, 888)
    ...
    def test_list_get_range_index_type_string(self):
        ...
        with pytest.raises(TypeError) as typeError:
            TestListGetRange.client.list_get_range(key, "contact_no", "Fifth", 2)
