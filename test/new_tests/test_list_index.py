...
class TestListIndex(object):
    ...
    def test_pos_listindex_with_correct_parameters_set_length_extra(self):
        ...
        for _ in range(100):
            set_name = set_name + "a"
        policy = {}
        with pytest.raises((Exception, e.InvalidRequest)) as excinfo:
    ...
    def test_pos_createlistindex_with_policy(self):
        ...
        assert retobj == 0
        self.as_connection.index_remove("test", "test_numeric_list_index_pol", policy)
