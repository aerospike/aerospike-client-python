...
class TestKV(object):
    ...
    def test_with_single_key(self):
        ...
        # remove it
        status = self.as_connection.remove(get_key_with_digest_only(key))
        assert status == 0, "wrong return code"
    ...
    def test_with_multiple_keys(self):
        ...
        self.as_connection.index_single_value_create("test", "unittest", "age", aerospike.INDEX_INTEGER, "age_index", {})
