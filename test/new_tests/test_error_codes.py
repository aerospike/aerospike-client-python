...
from .as_errors import AEROSPIKE_ERR_ASYNC_CONNECTION, AEROSPIKE_ERR_BATCH_DISABLED, AEROSPIKE_ERR_BATCH_MAX_REQUESTS_EXCEEDED, AEROSPIKE_ERR_BATCH_QUEUES_FULL, AEROSPIKE_ERR_CLIENT_ABORT, AEROSPIKE_ERR_FAIL_ELEMENT_EXISTS, AEROSPIKE_ERR_FAIL_ELEMENT_NOT_FOUND, AEROSPIKE_ERR_INVALID_NODE, AEROSPIKE_ERR_NO_MORE_CONNECTIONS, AEROSPIKE_ERR_QUERY_ABORTED, AEROSPIKE_ERR_SCAN_ABORTED, AEROSPIKE_ERR_TLS_ERROR
