...
class TestOperate(object):
    ...
    def test_pos_operate_with_increment_positive_float_value(self):
        ...
        key = ("test", "demo", 6)
        llist = [
            {"op": aerospike.OPERATOR_INCR, "bin": "age", "val": 3.5},
    ...
    @pytest.mark.parametrize(
        "key, llist",
        [
            (("test", "demo", 1), [{"op": aerospike.OPERATOR_TOUCH, "val": 4000}]),
            (("test", "demo", 1), [{"op": aerospike.OPERATOR_TOUCH, "bin": "age", "val": 4000}]),
            (("test", "demo", 1), [{"op": aerospike.OPERATOR_TOUCH, "bin": "age"}]),
            (("test", "demo", 1), [{"op": aerospike.OPERATOR_TOUCH}]),
        ],
    )
    ...
    def test_pos_operate_with_nonexistent_bin(self):
        ...
        key = ("test", "demo", 1)
        llist = [
            string_operations.append("addr", "pune"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                [
                    {"op": aerospike.OPERATOR_INCR, "bin": "name", "val": "aerospike"},
                    {"op": aerospike.OPERATOR_READ, "bin": "name"},
                ],
                {"name": "aerospike"},
            ),
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                [
                    {"op": aerospike.OP_LIST_APPEND, "bin": "int_bin", "val": 7},
                    {"op": aerospike.OP_LIST_GET, "bin": "int_bin", "index": 4},
                ],
                {"int_bin": 7},
                "int_bin",
                [1, 2, 3, 4, 7],
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                [
                    {"op": aerospike.OP_LIST_REMOVE, "bin": "int_bin", "index": 2},
                ],
                "int_bin",
                [1, 2, 4],
            ),
            ...
            ([{"op": aerospike.OP_LIST_CLEAR, "bin": "int_bin"}], "int_bin", []),
        ],
    )
    ...
    def test_pos_operate_with_list_size(self):
        ...
        """
        key = ("test", "demo", "list_key")
        list = [{"op": aerospike.OP_LIST_SIZE, "bin": "int_bin"}]
    ...
    @pytest.mark.parametrize(
        "list",
        [
            ([{"op": aerospike.OP_LIST_GET, "bin": "int_bin", "index": 7}]),
            (
                [
                    {"op": aerospike.OP_LIST_CLEAR, "bin": "int_bin"},
                    {"op": aerospike.OP_LIST_POP, "bin": "int_bin", "index": 2},
                ]
            ),
            (
    ...
    def test_neg_operate_with_extra_parameter(self):
        ...
        assert "operate() takes at most 4 arguments (5 given)" in str(typeError.value)
    ...
    def test_neg_operate_append_without_value_parameter(self, key, policy, llist, ex_code):
        """
    ...
    def test_neg_operate_append_value_integer(self):
        ...
        key = ("test", "demo", 1)
        llist = [
            {"op": aerospike.OPERATOR_APPEND, "bin": "name", "val": 12},
            {"op": aerospike.OPERATOR_INCR, "bin": "age", "val": 3},
            {"op": aerospike.OPERATOR_READ, "bin": "name"},
        ]
