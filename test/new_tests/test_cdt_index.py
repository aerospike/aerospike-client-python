...
class TestCDTIndex(object):
    ...
    def test_pos_cdtindex_with_listrank_correct_parameters(self):
        ...
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_list_rank}, policy)
    ...
    def test_pos_cdtindex_with_listvalue_correct_parameters(self):
        ...
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_list_value}, policy)
    ...
    def test_pos_cdtindex_with_mapindex_correct_parameters(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list', aerospike.INDEX_TYPE_MAPKEYS,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_map_index}, policy)
    ...
    def test_pos_cdtindex_with_mapvalue_correct_parameters(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list', aerospike.INDEX_TYPE_MAPVALUES,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_map_value}, policy)
    ...
    def test_pos_cdtindex_with_maprankvalue_correct_parameters(self):
        ...
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list', aerospike.INDEX_TYPE_MAPVALUES,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_map_rank}, policy)
    ...
    def test_pos_cdtindex_with_correct_parameters_numeric(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'numeric_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_NUMERIC,
            'test_numeric_list_cdt_index', {'ctx': ctx_list_index}, policy)

        assert retobj == 0
        self.as_connection.index_remove('test', 'test_numeric_list_cdt_index',
                                        policy)
    ...
    def test_pos_cdtindex_with_correct_parameters_set_length_extra(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test', set_name, 'string_list', aerospike.INDEX_TYPE_LIST,
aerospike.INDEX_STRING,
                "test_string_list_cdt_index", {'ctx': ctx_list_index}, policy)
            assert False
    ...
    def test_pos_cdtindex_with_incorrect_bin(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'string_list1', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_STRING,
            'test_string_list_cdt_index', {'ctx': ctx_list_index}, policy)
...
name
        ...
        if retobj == 0:
            try:
                retobj = self.as_connection.index_cdt_create(
                    'test', 'demo', 'string_list', aerospike.INDEX_TYPE_LIST,
                    aerospike.INDEX_STRING,
                    'test_string_list_cdt_index1', {'ctx': ctx_list_index}, policy)
            except e.IndexFoundError:
                assert self.server_version < [6, 1]
    ...
    def test_pos_createcdtindex_with_policy(self):
        ...
        policy = {'timeout': 1000}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo', 'num_list_pol', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_NUMERIC,
            'test_numeric_list_cdt_index_pol', {'ctx': ctx_list_index}, policy)

        assert retobj == 0
        self.as_connection.index_remove('test', 'test_numeric_list_cdt_index_pol',
                                        policy)
...
cfasdcalskdcbacfq34915rwcfasdcascnabscbaskjdbcalsjkbcdasc');
    ...
    def test_pos_create_liststringindex_unicode_positive(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', u'demo', u'string_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_STRING,
            u'uni_name_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_pos_create_list_integer_index_unicode(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', u'demo', u'numeric_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_NUMERIC,
            u'uni_age_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_namespace_is_none(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                None, 'demo', 'string_list', aerospike.INDEX_TYPE_LIST,
                aerospike.INDEX_STRING,
                'test_string_list_cdt_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_set_is_int(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test', 1, 'string_list', aerospike.INDEX_TYPE_LIST,
                aerospike.INDEX_STRING,
                'test_string_list_cdt_index', {'ctx': ctx_list_index}, policy)
            assert False
        except e.ParamError as exception:
    ...
    def test_neg_cdtindex_with_set_is_none(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test', None, 'string_list', aerospike.INDEX_TYPE_LIST,
                aerospike.INDEX_STRING,
                'test_string_list_cdt_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_bin_is_none(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test', 'demo', None, aerospike.INDEX_TYPE_LIST,
                aerospike.INDEX_NUMERIC,
                'test_numeric_list_cdt_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_index_is_none(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test', 'demo', 'string_list', aerospike.INDEX_TYPE_LIST,
                aerospike.INDEX_STRING,
                None, {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_incorrect_namespace(self):
        ...
        try:
            self.as_connection.index_cdt_create(
                'test1', 'demo', 'numeric_list', aerospike.INDEX_TYPE_DEFAULT,
                aerospike.INDEX_NUMERIC,
                'test_numeric_list_cdt_index', {'ctx': ctx_list_index}, policy)
    ...
    def test_neg_cdtindex_with_incorrect_set(self):
        ...
        policy = {}
        retobj = self.as_connection.index_cdt_create(
            'test', 'demo1', 'numeric_list', aerospike.INDEX_TYPE_LIST,
            aerospike.INDEX_NUMERIC,
            'test_numeric_list_cdt_index', {'ctx': ctx_list_index}, policy)
