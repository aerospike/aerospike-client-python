...
def add_indexes_to_client(client):
    try:
        client.index_single_value_create("test", "demo", "age", aerospike.INDEX_INTEGER, "test_demo_age_idx")
    except e.IndexFoundError:
        pass

    try:
        client.index_single_value_create("test", None, "age", aerospike.INDEX_INTEGER, "test_null_age_idx")
    except e.IndexFoundError:
        pass
