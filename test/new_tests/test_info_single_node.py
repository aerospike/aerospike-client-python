...
class TestInfoSingleNode(object):
    ...
    def test_info_single_node_positive_for_namespace(self):
        ...
        if self.pytest_skip:
            pytest.xfail()
        response = self.as_connection.info_single_node("namespaces", self.host_name)
    ...
    def test_info_single_node_positive_for_sets(self):
        ...
        if self.pytest_skip:
            pytest.xfail()
        response = self.as_connection.info_single_node("sets", self.host_name)
    ...
    def test_info_single_node_positive_for_sindex_creation(self):
        ...
        response = self.as_connection.info_single_node("sindex", self.host_name)
        self.as_connection.index_remove("test", "names_test_index")
...
class TestInfoSingleNodeIncorrectUsage(object):
    ...
    @pytest.mark.parametrize("host", ([(3000, 3000)], [], "123.456:1000", 3000, None))
