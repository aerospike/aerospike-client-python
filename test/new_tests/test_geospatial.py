...
def add_geo_indexes(connection):
    try:
        connection.index_geo2dsphere_create("test", "demo", "loc", aerospike.INDEX_GEO2DSPHERE, "loc_index")
    except (e.IndexFoundError):
        pass

    try:
        connection.index_geo2dsphere_create("test", "demo", "loc_polygon", aerospike.INDEX_GEO2DSPHERE, "loc_polygon_index")
    except (e.IndexFoundError):
        pass

    try:
        connection.index_geo2dsphere_create("test", "demo", "loc_circle", aerospike.INDEX_GEO2DSPHERE, "loc_circle_index")
    except (e.IndexFoundError):
        pass
...
class TestGeospatial(object):
    def setup_class(cls):
        ...
        Setup method.
        """
        cls.connection_setup_functions = (add_geo_indexes, add_geo_data)

        cls.connection_teardown_functions = (remove_geo_indexes, remove_geo_data)
    ...
    def test_geospatial_put_get_positive(self):
        ...
        self.as_connection.put(
            key,
            {
                ...
                "int_bin": 2,
                "string_bin": "str",
                "dict_bin": {"a": 1, "b": 2, "geo": geo_object_dict},
            },
        )
    ...
    def test_geospatial_positive_query_without_set(self):
        ...
        try:
            self.as_connection.index_geo2dsphere_create("test", None, "loc", aerospike.INDEX_GEO2DSPHERE, "loc_index_no_set")
        except (e.IndexFoundError):
            pass
    ...
    def test_geospatial_2dindex_positive(self):
        ...
        status = self.as_connection.index_geo2dsphere_create("test", "demo", "loc", aerospike.INDEX_GEO2DSPHERE, "loc_index")
    ...
    def test_geospatial_2dindex_positive_with_policy(self):
        ...
        status = self.as_connection.index_geo2dsphere_create("test", "demo", "loc", aerospike.INDEX_GEO2DSPHERE, "loc_index", {"timeout": 180000})
    ...
    def test_geospatial_positive_query_with_point_in_aerocircle(self):
        ...
        assert len(records) == 1
        expected = [{"coordinates": [[-122.0, 37.0], 250.2], "type": "AeroCircle"}]
        for r in records:
    ...
    def test_geospatial_positive_query_with_point_in_aerocircle_int(self):
        ...
        geo_object2 = aerospike.GeoJSON({"type": "Point", "coordinates": [-122, 37]})
    ...
    def test_geospatial_within_radius_pred(self, bin_name, idx_type):
        ...
        predicate = p.geo_within_radius(bin_name, -122.0, 37.5, 250.2, idx_type)
    ...
    def test_geospatial_within_geojson_region_pred(self, bin_name, idx_type):
        ...
        predicate = p.geo_within_geojson_region(bin_name, geo_object2.dumps(), idx_type)
    ...
    def test_geospatial_contains_point_pred(self, bin_name, idx_type):
        ...
        predicate = p.geo_contains_point(bin_name, lat, lon, idx_type)
    ...
    def test_geospatial_contains_json_point_pred(self, bin_name, idx_type):
        ...
        predicate = p.geo_contains_geojson_point(bin_name, point.dumps(), idx_type)
    ...
    def test_geospatial_2dindex_set_length_extra(self):
        ...
        with pytest.raises(e.InvalidRequest) as err_info:
            self.as_connection.index_geo2dsphere_create("test", set_name, "loc", aerospike.INDEX_GEO2DSPHERE, "loc_index_creation_should_fail")
