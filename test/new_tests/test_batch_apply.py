...
class TestBatchApply(TestBaseClass):
    ...
    @pytest.mark.parametrize("name, keys, module, function, args, policy_batch, policy_batch_apply, exp_res, exp_rec, exp_change, change_bin", [
        (
            "list-append",
            [
                ("test", "demo", 0),
        ...
        (
            ...
            [],
            {
                ...
                "expressions": exp.Eq(exp.ListGetByRank(None, aerospike.LIST_RETURN_VALUE, exp.ResultType.STRING, 0, exp.ListBin("name")), "name0").compile()
            },
            {},
            [AerospikeStatus.AEROSPIKE_OK],
            [{"SUCCESS": True}],
    ...
    def test_batch_apply_pos(self, name, keys, module, function, args, policy_batch, policy_batch_apply, exp_res, exp_rec, exp_change, change_bin):
        """
    ...
    @pytest.mark.parametrize("name, keys, module, function, args, policy_batch, policy_batch_apply, exp_res", [
        (
            "bad-key",
            [
