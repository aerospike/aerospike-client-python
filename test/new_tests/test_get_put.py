...
class TestGetPut:
    ...
    def test_pos_get_initkey_with_digest(self, put_data):
        ...
        put_data(self.as_connection, key, rec, _policy=policy)
    ...
    def test_neg_get_with_extra_parameter_in_key(self, put_data):
        ...
        """
        key = ("test", "demo", None, bytearray("asd;as[d'as;djk;uyfl", "utf-8"), 1)
        rec = {"name": "john"}
    ...
    def test_neg_put_without_record(self):
        ...
        assert "argument 'bins' (pos 2)" in str(typeError.value)
    ...
    def test_put_invalid_type(self):
        ...
        assert excinfo.value.msg == "Invalid value type: 14"
