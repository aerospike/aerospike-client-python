...
def expression_read(expression: resources._BaseExpr, expression_read_flags=None: int): #TODO create typehint type for flags
...
def expression_write(bin_name: str, expression: resources._BaseExpr, expression_write_flags=None: int): #TODO create typehint type for flags
