...
class Client:
    ...
    def index_geo2dsphere_create(self, ns: str, set: str, bin: str, index_name: str, policy: dict = ...) -> None: ...
    def index_integer_create(self, ns: str, set: str, bin: str, index_name: str, policy: dict = ...) -> None: ...
    def index_list_create(self, ns: str, set: str, bin: str, index_datatype, index_name: str, policy: dict = ...) -> None: ...
    def index_map_keys_create(self, ns: str, set: str, bin: str, index_datatype, index_name: str, policy: dict = ...) -> None: ...
    def index_map_values_create(self, ns: str, set: str, bin: str, index_datatype, index_name: str, policy: dict = ...) -> None: ...
    def index_remove(self, ns, index_name, policy: dict = ...) -> None: ...
    def index_string_create(self, ns: str, set: str, bin: str, index_name: str, policy: dict = ...) -> None: ...
    def info(self, command, hosts = ..., policy: dict = ...) -> dict: ...
    def info_all(self, command: str, policy: dict = ...) -> dict: ...
    def info_node(self, command: str, host: tuple, policy: dict = ...) -> str: ...
    ...
    def operate(self, key: tuple, operations: list, meta: dict = ..., policy: dict = ...) -> tuple: ...
    def operate_ordered(self, key: tuple, operations: list, meta: dict = ..., policy: dict = ...) -> list: ...
    ...
    def truncate(self, namespace: str, set: str, nanos: long, policy: dict = ...) -> int: ...
...
class Query:
    ...
    def foreach(self, *args, **kwargs) -> None: ...
    ...
    def select(self, bin1: str = ..., bin2: str = ...,) -> None: ...
...
def set_deserializer(callback) -> None: ...
def set_log_handler(callback) -> None: ...
def set_log_level(log_level: int) -> None: ...
def set_serializer(callback) -> None: ...
