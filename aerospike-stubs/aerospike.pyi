...
class Client:
    ...
    # Index creation for root-level CDTs
    # We cannot use aerospike_helpers's TypeExpression type because mypy's stubtest will complain
    ...
    def index_cdt_create(self, ns: str, set: str, bin: str, index_type: int, index_datatype: int, name: str, ctx: dict, policy: dict = ...) -> int: ...
