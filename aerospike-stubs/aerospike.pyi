...
class Client:
    ...
    def index_expression_create(self, ns: str, set: str, bin: str, index_datatype: Any, index_type: Any, name: str, expression: Any, policy: dict = ...) -> None: ...
...
class Query:
    ...
    def where_index_name(self, predicate: tuple, index_name: str) -> None: ...
    def where_exp(self, expression: Any, predicate: tuple, client: Client = ...) -> None: ...
