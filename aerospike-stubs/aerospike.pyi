...
class Client:
    ...
    def commit(self, transaction: Transaction, get_commit_status: bool = False) -> Optional[int]: ...
    def abort(self, transaction: Transaction, get_abort_status: bool = False) -> Optional[int]: ...
