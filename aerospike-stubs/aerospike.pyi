...
class Client:
    ...
    # We cannot use aerospike_helpers's TypeExpression type because mypy's stubtest will complain
    def index_single_value_create(self, ns: str, set: str, bin: str, index_datatype, name: str, policy: dict = ..., ctx: Optional[list] = ...) -> None: ...
    def index_list_create(self, ns: str, set: str, bin: str, index_datatype, name: str, policy: dict = ..., ctx: Optional[list] = ...) -> None: ...
    def index_map_keys_create(self, ns: str, set: str, bin: str, index_datatype, name: str, policy: dict = ..., ctx: Optional[list] = ...) -> None: ...
    def index_map_values_create(self, ns: str, set: str, bin: str, index_datatype, name: str, policy: dict = ..., ctx: Optional[list] = ...) -> None: ...
