...
OPERATOR_APPEND: Literal[0]
OPERATOR_DELETE: Literal[0]
OPERATOR_INCR: Literal[0]
OPERATOR_PREPEND: Literal[0]
OPERATOR_READ: Literal[0]
OPERATOR_TOUCH: Literal[0]
OPERATOR_WRITE: Literal[0]
OP_BIT_ADD: Literal[0]
OP_BIT_AND: Literal[0]
OP_BIT_COUNT: Literal[0]
OP_BIT_GET: Literal[0]
OP_BIT_GET_INT: Literal[0]
OP_BIT_INSERT: Literal[0]
OP_BIT_LSCAN: Literal[0]
OP_BIT_LSHIFT: Literal[0]
OP_BIT_NOT: Literal[0]
OP_BIT_OR: Literal[0]
OP_BIT_REMOVE: Literal[0]
OP_BIT_RESIZE: Literal[0]
OP_BIT_RSCAN: Literal[0]
OP_BIT_RSHIFT: Literal[0]
OP_BIT_SET: Literal[0]
OP_BIT_SET_INT: Literal[0]
OP_BIT_SUBTRACT: Literal[0]
OP_BIT_XOR: Literal[0]
OP_EXPR_READ: Literal[0]
OP_EXPR_WRITE: Literal[0]
OP_HLL_ADD: Literal[0]
OP_HLL_DESCRIBE: Literal[0]
OP_HLL_FOLD: Literal[0]
OP_HLL_GET_COUNT: Literal[0]
OP_HLL_GET_INTERSECT_COUNT: Literal[0]
OP_HLL_GET_SIMILARITY: Literal[0]
OP_HLL_GET_UNION: Literal[0]
OP_HLL_GET_UNION_COUNT: Literal[0]
OP_HLL_INIT: Literal[0]
OP_HLL_MAY_CONTAIN: Literal[0]
OP_HLL_REFRESH_COUNT: Literal[0]
OP_HLL_SET_UNION: Literal[0]
OP_LIST_APPEND: Literal[0]
OP_LIST_APPEND_ITEMS: Literal[0]
OP_LIST_CLEAR: Literal[0]
OP_LIST_GET: Literal[0]
OP_LIST_GET_BY_INDEX: Literal[0]
OP_LIST_GET_BY_INDEX_RANGE: Literal[0]
OP_LIST_GET_BY_INDEX_RANGE_TO_END: Literal[0]
OP_LIST_GET_BY_RANK: Literal[0]
OP_LIST_GET_BY_RANK_RANGE: Literal[0]
OP_LIST_GET_BY_RANK_RANGE_TO_END: Literal[0]
OP_LIST_GET_BY_VALUE: Literal[0]
OP_LIST_GET_BY_VALUE_LIST: Literal[0]
OP_LIST_GET_BY_VALUE_RANGE: Literal[0]
OP_LIST_GET_BY_VALUE_RANK_RANGE_REL: Literal[0]
OP_LIST_GET_BY_VALUE_RANK_RANGE_REL_TO_END: Literal[0]
OP_LIST_GET_RANGE: Literal[0]
OP_LIST_INCREMENT: Literal[0]
OP_LIST_INSERT: Literal[0]
OP_LIST_INSERT_ITEMS: Literal[0]
OP_LIST_POP: Literal[0]
OP_LIST_POP_RANGE: Literal[0]
OP_LIST_REMOVE: Literal[0]
OP_LIST_REMOVE_BY_INDEX: Literal[0]
OP_LIST_REMOVE_BY_INDEX_RANGE: Literal[0]
OP_LIST_REMOVE_BY_INDEX_RANGE_TO_END: Literal[0]
OP_LIST_REMOVE_BY_RANK: Literal[0]
OP_LIST_REMOVE_BY_RANK_RANGE: Literal[0]
OP_LIST_REMOVE_BY_RANK_RANGE_TO_END: Literal[0]
OP_LIST_REMOVE_BY_REL_RANK_RANGE: Literal[0]
OP_LIST_REMOVE_BY_REL_RANK_RANGE_TO_END: Literal[0]
OP_LIST_REMOVE_BY_VALUE: Literal[0]
OP_LIST_REMOVE_BY_VALUE_LIST: Literal[0]
OP_LIST_REMOVE_BY_VALUE_RANGE: Literal[0]
OP_LIST_REMOVE_BY_VALUE_RANK_RANGE_REL: Literal[0]
OP_LIST_REMOVE_RANGE: Literal[0]
OP_LIST_SET: Literal[0]
OP_LIST_SET_ORDER: Literal[0]
OP_LIST_SIZE: Literal[0]
OP_LIST_SORT: Literal[0]
OP_LIST_TRIM: Literal[0]
OP_MAP_CLEAR: Literal[0]
OP_MAP_DECREMENT: Literal[0]
OP_MAP_GET_BY_INDEX: Literal[0]
OP_MAP_GET_BY_INDEX_RANGE: Literal[0]
OP_MAP_GET_BY_INDEX_RANGE_TO_END: Literal[0]
OP_MAP_GET_BY_KEY: Literal[0]
OP_MAP_GET_BY_KEY_INDEX_RANGE_REL: Literal[0]
OP_MAP_GET_BY_KEY_LIST: Literal[0]
OP_MAP_GET_BY_KEY_RANGE: Literal[0]
OP_MAP_GET_BY_KEY_REL_INDEX_RANGE: Literal[0]
OP_MAP_GET_BY_KEY_REL_INDEX_RANGE_TO_END: Literal[0]
OP_MAP_GET_BY_RANK: Literal[0]
OP_MAP_GET_BY_RANK_RANGE: Literal[0]
OP_MAP_GET_BY_RANK_RANGE_TO_END: Literal[0]
OP_MAP_GET_BY_VALUE: Literal[0]
OP_MAP_GET_BY_VALUE_LIST: Literal[0]
OP_MAP_GET_BY_VALUE_RANGE: Literal[0]
OP_MAP_GET_BY_VALUE_RANK_RANGE_REL: Literal[0]
OP_MAP_GET_BY_VALUE_RANK_RANGE_REL_TO_END: Literal[0]
OP_MAP_INCREMENT: Literal[0]
OP_MAP_PUT: Literal[0]
OP_MAP_PUT_ITEMS: Literal[0]
OP_MAP_REMOVE_BY_INDEX: Literal[0]
OP_MAP_REMOVE_BY_INDEX_RANGE: Literal[0]
OP_MAP_REMOVE_BY_INDEX_RANGE_TO_END: Literal[0]
OP_MAP_REMOVE_BY_KEY: Literal[0]
OP_MAP_REMOVE_BY_KEY_INDEX_RANGE_REL: Literal[0]
OP_MAP_REMOVE_BY_KEY_LIST: Literal[0]
OP_MAP_REMOVE_BY_KEY_RANGE: Literal[0]
OP_MAP_REMOVE_BY_KEY_REL_INDEX_RANGE: Literal[0]
OP_MAP_REMOVE_BY_KEY_REL_INDEX_RANGE_TO_END: Literal[0]
OP_MAP_REMOVE_BY_RANK: Literal[0]
OP_MAP_REMOVE_BY_RANK_RANGE: Literal[0]
OP_MAP_REMOVE_BY_RANK_RANGE_TO_END: Literal[0]
OP_MAP_REMOVE_BY_VALUE: Literal[0]
OP_MAP_REMOVE_BY_VALUE_LIST: Literal[0]
OP_MAP_REMOVE_BY_VALUE_RANGE: Literal[0]
OP_MAP_REMOVE_BY_VALUE_RANK_RANGE_REL: Literal[0]
OP_MAP_REMOVE_BY_VALUE_REL_INDEX_RANGE: Literal[0]
OP_MAP_REMOVE_BY_VALUE_REL_RANK_RANGE: Literal[0]
OP_MAP_REMOVE_BY_VALUE_REL_RANK_RANGE_TO_END: Literal[0]
OP_MAP_SET_POLICY: Literal[0]
OP_MAP_SIZE: Literal[0]
POLICY_COMMIT_LEVEL_ALL: Literal[0]
POLICY_COMMIT_LEVEL_MASTER: Literal[0]
POLICY_EXISTS_CREATE: Literal[0]
POLICY_EXISTS_CREATE_OR_REPLACE: Literal[0]
POLICY_EXISTS_IGNORE: Literal[0]
POLICY_EXISTS_REPLACE: Literal[0]
POLICY_EXISTS_UPDATE: Literal[0]
POLICY_GEN_EQ: Literal[0]
POLICY_GEN_GT: Literal[0]
POLICY_GEN_IGNORE: Literal[0]
POLICY_KEY_DIGEST: Literal[0]
POLICY_KEY_SEND: Literal[0]
POLICY_READ_MODE_AP_ALL: Literal[0]
POLICY_READ_MODE_AP_ONE: Literal[0]
POLICY_READ_MODE_SC_ALLOW_REPLICA: Literal[0]
POLICY_READ_MODE_SC_ALLOW_UNAVAILABLE: Literal[0]
POLICY_READ_MODE_SC_LINEARIZE: Literal[0]
POLICY_READ_MODE_SC_SESSION: Literal[0]
POLICY_REPLICA_ANY: Literal[0]
POLICY_REPLICA_MASTER: Literal[0]
POLICY_REPLICA_PREFER_RACK: Literal[0]
POLICY_REPLICA_SEQUENCE: Literal[0]
POLICY_RETRY_NONE: Literal[0]
POLICY_RETRY_ONCE: Literal[0]
PRIV_DATA_ADMIN: Literal[0]
PRIV_READ: Literal[0]
PRIV_READ_WRITE: Literal[0]
PRIV_READ_WRITE_UDF: Literal[0]
PRIV_SINDEX_ADMIN: Literal[0]
PRIV_SYS_ADMIN: Literal[0]
PRIV_TRUNCATE: Literal[0]
PRIV_UDF_ADMIN: Literal[0]
PRIV_USER_ADMIN: Literal[0]
PRIV_WRITE: Literal[0]
REGEX_EXTENDED: Literal[0]
REGEX_ICASE: Literal[0]
REGEX_NEWLINE: Literal[0]
REGEX_NONE: Literal[0]
REGEX_NOSUB: Literal[0]
SERIALIZER_JSON: Literal[0]
SERIALIZER_NONE: Literal[0]
SERIALIZER_USER: Literal[0]
TTL_DONT_UPDATE: Literal[0]
TTL_NAMESPACE_DEFAULT: Literal[0]
TTL_NEVER_EXPIRE: Literal[0]
