...
class Client:
    ...
    def admin_change_password(self, user: str, password: str, policy: dict = ...) -> None: ...
    ...
    def admin_create_user(self, user: str, password: str, roles: list, policy: dict = ...) -> None: ...
    def admin_drop_role(self, role: str, policy: dict = ...) -> None: ...
    def admin_drop_user(self, user: str, policy: dict = ...) -> None: ...
    ...
    def admin_grant_roles(self, user: str, roles: list, policy: dict = ...) -> None: ...
    ...
    def admin_revoke_roles(self, user: str, roles: list, policy: dict = ...) -> None: ...
    def admin_set_password(self, user: str, password: str, policy: dict = ...) -> None: ...
