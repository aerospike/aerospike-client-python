...
.. class:: Query
    ...
    .. method:: select(bin1[, bin2[, bin3..]])
        ...
        .. warning:: In the next major client release, calling this method after :meth:`Query.add_ops` was called on it will raise a :py:exc:`~aerospike.exception.ParamError` exception.
