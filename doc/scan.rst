...
.. class:: Scan
    ...
    .. method:: apply(module, function[, arguments])
        ...
        object. Executing the scan as either a foreground or background scan will raise a
    ...
    .. method:: add_ops(ops)
        ...
        For background scans, only write operations are allowed.
