...
#define PREPEND_SUBMODULE(class_name) "exception.##class_name"
...
struct exception_def exception_defs[] = {
    {PREPEND_SUBMODULE(AerospikeError), NULL, NO_ERROR_CODE,
     aerospike_err_attrs},
    ...
    {PREPEND_SUBMODULE(TimeoutError), AEROSPIKE_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_TIMEOUT, NULL},
    // Client errors
    {PREPEND_SUBMODULE(ParamError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_PARAM, NULL},
    {PREPEND_SUBMODULE(InvalidHostError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INVALID_HOST, NULL},
    {PREPEND_SUBMODULE(ConnectionError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_CONNECTION, NULL},
    {PREPEND_SUBMODULE(TLSError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_TLS_ERROR, NULL},
    {PREPEND_SUBMODULE(BatchFailed), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_BATCH_FAILED, NULL},
    {PREPEND_SUBMODULE(NoResponse), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_NO_RESPONSE, NULL},
    {PREPEND_SUBMODULE(MaxErrorRateExceeded), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_MAX_ERROR_RATE, NULL},
    {PREPEND_SUBMODULE(MaxRetriesExceeded), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_MAX_RETRIES_EXCEEDED, NULL},
    {PREPEND_SUBMODULE(InvalidNodeError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INVALID_NODE, NULL},
    {PREPEND_SUBMODULE(NoMoreConnectionsError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_NO_MORE_CONNECTIONS, NULL},
    {PREPEND_SUBMODULE(AsyncConnectionError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_ASYNC_CONNECTION, NULL},
    {PREPEND_SUBMODULE(ClientAbortError), CLIENT_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_CLIENT_ABORT, NULL},
    // Server errors
    {PREPEND_SUBMODULE(InvalidRequest), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_REQUEST_INVALID, NULL},
    {PREPEND_SUBMODULE(ServerFull), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_SERVER_FULL, NULL},
    {PREPEND_SUBMODULE(AlwaysForbidden), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_ALWAYS_FORBIDDEN, NULL},
    {PREPEND_SUBMODULE(UnsupportedFeature), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_UNSUPPORTED_FEATURE, NULL},
    {PREPEND_SUBMODULE(DeviceOverload), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_DEVICE_OVERLOAD, NULL},
    {PREPEND_SUBMODULE(NamespaceNotFound), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_NAMESPACE_NOT_FOUND, NULL},
    {PREPEND_SUBMODULE(ForbiddenError), SERVER_ERR_EXCEPTION_NAME,
    ...
    {PREPEND_SUBMODULE(InvalidGeoJSON), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_GEO_INVALID_GEOJSON, NULL},
    {PREPEND_SUBMODULE(OpNotApplicable), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_OP_NOT_APPLICABLE, NULL},
    {PREPEND_SUBMODULE(FilteredOut), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_FILTERED_OUT, NULL},
    {PREPEND_SUBMODULE(LostConflict), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_LOST_CONFLICT, NULL},
    {PREPEND_SUBMODULE(ScanAbortedError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_SCAN_ABORTED, NULL},
    {PREPEND_SUBMODULE(ElementNotFoundError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_FAIL_ELEMENT_NOT_FOUND, NULL},
    {PREPEND_SUBMODULE(ElementExistsError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_FAIL_ELEMENT_EXISTS, NULL},
    {PREPEND_SUBMODULE(BatchDisabledError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BATCH_DISABLED, NULL},
    {PREPEND_SUBMODULE(BatchMaxRequestError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BATCH_MAX_REQUESTS_EXCEEDED, NULL},
    {PREPEND_SUBMODULE(BatchQueueFullError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BATCH_QUEUES_FULL, NULL},
    {PREPEND_SUBMODULE(QueryAbortedError), SERVER_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_QUERY_ABORTED, NULL},
    // Cluster errors
    {PREPEND_SUBMODULE(ClusterChangeError), CLUSTER_ERR_EXCEPTION_NAME,
    ...
    {RECORD_ERR_EXCEPTION_NAME, SERVER_ERR_EXCEPTION_NAME, NO_ERROR_CODE,
     record_err_attrs},
    {PREPEND_SUBMODULE(RecordKeyMismatch), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_KEY_MISMATCH, NULL},
    {PREPEND_SUBMODULE(RecordNotFound), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_NOT_FOUND, NULL},
    {PREPEND_SUBMODULE(RecordGenerationError), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_GENERATION, NULL},
    {PREPEND_SUBMODULE(RecordExistsError), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_EXISTS, NULL},
    {PREPEND_SUBMODULE(RecordTooBig), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_TOO_BIG, NULL},
    {PREPEND_SUBMODULE(RecordBusy), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_RECORD_BUSY, NULL},
    {PREPEND_SUBMODULE(BinNameError), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BIN_NAME, NULL},
    {PREPEND_SUBMODULE(BinIncompatibleType), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BIN_INCOMPATIBLE_TYPE, NULL},
    {PREPEND_SUBMODULE(BinExistsError), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BIN_EXISTS, NULL},
    {PREPEND_SUBMODULE(BinNotFound), RECORD_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_BIN_NOT_FOUND, NULL},
    // Index errors
    {INDEX_ERR_EXCEPTION_NAME, SERVER_ERR_EXCEPTION_NAME, AEROSPIKE_ERR_INDEX,
     index_err_attrs},
    {PREPEND_SUBMODULE(IndexNotFound), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_NOT_FOUND, NULL},
    {PREPEND_SUBMODULE(IndexFoundError), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_FOUND, NULL},
    {PREPEND_SUBMODULE(IndexOOM), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_OOM, NULL},
    {PREPEND_SUBMODULE(IndexNotReadable), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_NOT_READABLE, NULL},
    {PREPEND_SUBMODULE(IndexNameMaxLen), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_NAME_MAXLEN, NULL},
    {PREPEND_SUBMODULE(IndexNameMaxCount), INDEX_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_INDEX_MAXCOUNT, NULL},
    // UDF errors
    {UDF_ERR_EXCEPTION_NAME, SERVER_ERR_EXCEPTION_NAME, AEROSPIKE_ERR_UDF,
     udf_err_attrs},
    {PREPEND_SUBMODULE(UDFNotFound), UDF_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_UDF_NOT_FOUND, NULL},
    {PREPEND_SUBMODULE(LuaFileNotFound), UDF_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_LUA_FILE_NOT_FOUND, NULL},
    // Admin errors
    {ADMIN_ERR_EXCEPTION_NAME, SERVER_ERR_EXCEPTION_NAME, NO_ERROR_CODE, NULL},
    {PREPEND_SUBMODULE(SecurityNotSupported), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_SECURITY_NOT_SUPPORTED, NULL},
    {PREPEND_SUBMODULE(SecurityNotEnabled), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_SECURITY_NOT_ENABLED, NULL},
    {PREPEND_SUBMODULE(SecuritySchemeNotSupported), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_SECURITY_SCHEME_NOT_SUPPORTED, NULL},
    {PREPEND_SUBMODULE(InvalidCommand), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_COMMAND, NULL},
    {PREPEND_SUBMODULE(InvalidField), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_FIELD, NULL},
    {PREPEND_SUBMODULE(IllegalState), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_ILLEGAL_STATE, NULL},
    {PREPEND_SUBMODULE(InvalidUser), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_USER, NULL},
    {PREPEND_SUBMODULE(UserExistsError), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_USER_ALREADY_EXISTS, NULL},
    {PREPEND_SUBMODULE(InvalidPassword), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_PASSWORD, NULL},
    {PREPEND_SUBMODULE(ExpiredPassword), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_EXPIRED_PASSWORD, NULL},
    {PREPEND_SUBMODULE(ForbiddenPassword), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_FORBIDDEN_PASSWORD, NULL},
    {PREPEND_SUBMODULE(InvalidCredential), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_CREDENTIAL, NULL},
    {PREPEND_SUBMODULE(InvalidRole), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_ROLE, NULL},
    {PREPEND_SUBMODULE(RoleExistsError), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_ROLE_ALREADY_EXISTS, NULL},
    {PREPEND_SUBMODULE(RoleViolation), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_ROLE_VIOLATION, NULL},
    {PREPEND_SUBMODULE(InvalidPrivilege), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_PRIVILEGE, NULL},
    {PREPEND_SUBMODULE(NotAuthenticated), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_NOT_AUTHENTICATED, NULL},
    {PREPEND_SUBMODULE(InvalidWhitelist), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_WHITELIST, NULL},
    {PREPEND_SUBMODULE(NotWhitelisted), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_NOT_WHITELISTED, NULL},
    {PREPEND_SUBMODULE(QuotasNotEnabled), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_QUOTAS_NOT_ENABLED, NULL},
    {PREPEND_SUBMODULE(InvalidQuota), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_INVALID_QUOTA, NULL},
    {PREPEND_SUBMODULE(QuotaExceeded), ADMIN_ERR_EXCEPTION_NAME,
     AEROSPIKE_QUOTA_EXCEEDED, NULL},
    // Query errors
    {PREPEND_SUBMODULE(QueryQueueFull), QUERY_ERR_EXCEPTION_NAME,
     AEROSPIKE_ERR_QUERY_QUEUE_FULL, NULL},
    {PREPEND_SUBMODULE(QueryTimeout), QUERY_ERR_EXCEPTION_NAME,
