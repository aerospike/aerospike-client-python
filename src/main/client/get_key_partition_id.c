...
PyObject * AerospikeClient_Get_Key_PartitionID_Invoke(
	...
	PyObject * py_ns, PyObject *py_set, PyObject * py_key)
{
	...
	uint32_t id = as_partition_getid(key.digest.value, self->as->cluster->n_partitions);
...
PyObject * AerospikeClient_Get_Key_PartitionID(AerospikeClient * self, PyObject * args, PyObject * kwds)
{
	...
	// Invoke Operation
	return AerospikeClient_Get_Key_PartitionID_Invoke(self, py_ns, py_set, py_key);
}
