...
static PyMethodDef AerospikeClient_Type_Methods[] = {
	...
	{"admin_query_user_info",
		(PyCFunction) AerospikeClient_Admin_Query_User_Info, METH_VARARGS | METH_KEYWORDS,
	...
	{"admin_query_users_info",	(PyCFunction) AerospikeClient_Admin_Query_Users_Info, METH_VARARGS | METH_KEYWORDS,
	...
	{"admin_get_role",
		(PyCFunction) AerospikeClient_Admin_Get_Role, METH_VARARGS | METH_KEYWORDS,
		"Get a user defined role."},
	{"admin_get_roles",
		(PyCFunction) AerospikeClient_Admin_Get_Roles, METH_VARARGS | METH_KEYWORDS,
