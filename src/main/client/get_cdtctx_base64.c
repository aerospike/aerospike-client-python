											  ...
											  PyObject *args, PyObject *kwds)
{
	...
	if (PyArg_ParseTupleAndKeywords(args, kwds, "O:get_cdtctx_base64",
									kwlist, &py_cdtctx) == false) {
		return NULL;
	}
	...
	if (py_cdtctx == NULL || !PyDict_Check(py_cdtctx)) {
		as_error_update(&err, AEROSPIKE_ERR_PARAM,
						"cdt ctx must be a non empty list "
						", generated by a compiled aerospike cdt context");
		goto CLEANUP;
	}
