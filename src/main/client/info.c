...
/**
 ******************************************************************************************************
 * Returns data for a particular request string to AerospikeClient_Info
 *
 ...
 ********************************************************************************************************/
static PyObject * AerospikeClient_Info_Invoke(
...
PyObject * AerospikeClient_Info(AerospikeClient * self, PyObject * args, PyObject * kwds)
{
	...
	return AerospikeClient_Info_Invoke(self, request, py_host, py_policy);
...
static PyObject * AerospikeClient_GetNodes_Invoke(
	...
	response_services_p = AerospikeClient_Info_Invoke(self, "services", NULL, NULL);
	if(!response_services_p) {
		as_error_update(&err, AEROSPIKE_ERR_CLIENT, "Services call returned an error");
		goto CLEANUP;
	}

	response_service_p = AerospikeClient_Info_Invoke(self, "service", NULL, NULL);
