...
static PyObject * AerospikeWildCardType_New(PyTypeObject * parent, PyObject * args, PyObject * kwds);
static PyObject * AerospikeInfiniteType_New(PyTypeObject * parent, PyObject * args, PyObject * kwds);
...
{
	return PyType_Ready(&AerospikeCDTWildcard_Type) == 0 ? &AerospikeCDTWildcard_Type : NULL;
}

static PyTypeObject AerospikeCDTInfinite_Type = {
	PyVarObject_HEAD_INIT(NULL, 0)
	AS_CDT_INFINITE_NAME,                   // tp_name
...
{
	return PyType_Ready(&AerospikeCDTInfinite_Type) == 0 ? &AerospikeCDTInfinite_Type : NULL;
}
